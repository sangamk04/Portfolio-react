    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          Hello! My name is Sangam Kumar Singh. I am an independent developer & designer. I like many different directions related to the development of digital products.
            <br/>
            <br/>
